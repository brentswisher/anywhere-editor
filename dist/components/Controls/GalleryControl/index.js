...
function GalleryEditor(props) {
  var cssClasses = (0, _reactRedux.useSelector)(_configSlice.selectCssClasses),
    ...
    switch (action.type) {
      ...
      case 'updateSrc':
        return state.map(function (image, index) {
          return index === action.index ? _objectSpread(_objectSpread({}, image), {}, {
            src: action.value,
            hasUpload: true
          }) : image;
        });
    ...
    if (images.length < props.maxImages) {
      ...
      setError("You may currently only add up to  ".concat(props.maxImages, " images to a gallery"));
    }
  },
    ...
    try {
      for (_iterator.s(); !(_step = _iterator.n()).done;) {
        ...
        if (!Object.keys(image.src).length) {
          setError("Please upload a the photo for image ".concat(counter + 1, " or remove it to continue"));
          setCurrentTab(counter);
          errorFound = true;
          break;
        } else if (!image.alt.length) {
          setError("Please enter the photo alt text for image ".concat(counter + 1, " to continue"));
          setCurrentTab(counter);
          errorFound = true;
          break;
        }
  ...
  return /*#__PURE__*/_react.default.createElement(_EditModal.default, {
    ...
    return /*#__PURE__*/_react.default.createElement("li", {
      ...
      className: index === currentTab ? cssClasses['tab-title-active'] : cssClasses['tab-title'],
    ...
    return /*#__PURE__*/_react.default.createElement("div", {
      className: index === currentTab ? cssClasses['tab-panel-active'] : cssClasses['tab-panel'],
      key: index
    ...
    }, "Add Image"), /*#__PURE__*/_react.default.createElement("button", {
      onClick: function onClick() {
        return dispatchImage({
          type: 'remove',
          index: currentTab
...
function GalleryDisplay(props) {
  ...
  return /*#__PURE__*/_react.default.createElement("div", {
    ...
    className: cssClasses["text-".concat(props.headingPosition)]
  }, ' ', props.title, ' '), /*#__PURE__*/_react.default.createElement("div", {
    className: cssClasses['gallery-items']
  }, props.images.length && Object.keys(props.images[0].src).length ? props.images.map(function (image, index) {
    var displaySrc = (props.thumbnailPath !== '' ? "".concat(props.thumbnailPath, "/") : '') + image.src[image.sizes[image.sizes.length - 1]];
    return /*#__PURE__*/_react.default.createElement("div", {
      ...
      src: displaySrc,
      alt: image.alt
    }), image.caption && /*#__PURE__*/_react.default.createElement("div", {
      className: "".concat(cssClasses['gallery-item'], " ").concat(cssClasses['text-' + props.captionPosition]),
  ...
  }, "[Click here to upload images to the gallery]")), props.caption && props.caption.length && /*#__PURE__*/_react.default.createElement("div", {
    className: "".concat(cssClasses['gallery-item'], " ").concat(cssClasses['text-' + props.captionPosition]),
    dangerouslySetInnerHTML: {
