...
exports.HeadingControl = HeadingControl;
...
function HeadingControl(_ref) {
  ...
  if (editing) {
    return /*#__PURE__*/_react.default.createElement(HeadingEditor, {
      text: text,
      level: level,
      required: required,
      setData: setData,
  ...
  return /*#__PURE__*/_react.default.createElement(HeadingDisplay, {
    text: text,
    level: level,
    name: name,
...
function HeadingDisplay(props) {
  var cssClasses = (0, _reactRedux.useSelector)(_configSlice.selectCssClasses),
      ...
      HeadingEl = 'h' + (validHeadings.indexOf(props.level) ? props.level : '1');
  return /*#__PURE__*/_react.default.createElement(HeadingEl, {
    tabIndex: "0",
    onClick: props.onClick,
    className: cssClasses["heading-".concat(props.level)]
  }, props.text ? props.text : '[Enter heading text here]', /*#__PURE__*/_react.default.createElement("input", {
    type: "hidden",
    name: props.name,
    value: props.text
  }));
