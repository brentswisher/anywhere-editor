								...
								/*#__PURE__*/ _react.default.createElement(
									_ControlBlock.default,
									{
										...
										onDelete: function onDelete() {
											return dispatch(
												( 0,
												_layoutSlice.removeContentItem )(
													rowIndex
												)
											);
										},
									...
									row.innerContent.map( function (
										column,
										columnIndex
									) {
										var TheControl =
											controlLibrary[ column.type ]
												.control;
										return /*#__PURE__*/ _react.default.createElement(
											TheControl,
											_extends(
												{
													...
													setData: function setData(
														...
														return dispatch(
															( 0,
															_layoutSlice.setContentItemData )(
																{
																	rowIndex: rowIndex,
		...
		/*#__PURE__*/ _react.default.createElement(
			...
			controlList.map( function ( controlName ) {
				return /*#__PURE__*/ _react.default.createElement(
					...
					'Add ',
					controlLibrary[ controlName ].displayName
				);
			} )
		)
	);
